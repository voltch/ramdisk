...
# Setup for Cron Task
if [ ! -d /data/.volt ]; then
	$BB mkdir -p /data/.volt
	$BB chmod -R 0777 /.volt/
fi;
# Copy Cron files
...
echo "1586000" > /sys/devices/system/cpu/cpu0/cpufreq/volt_max_freq
echo "2496000" > /sys/devices/system/cpu/cpu4/cpufreq/volt_max_freq
